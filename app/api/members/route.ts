...
import {ensureHeaders, readCustomers, replaceCustomers} from '../../../lib/sheets'
...
export async function POST(request:Request){
  try{
    ...
    await ensureHeaders(); await replaceCustomers(found?customers.map(c=>c.id===found.id?updated:c):[...customers,updated])
